...
11. **Data Management** de `SMK Ejecutar Pruebas` y `SMK Ejecutar Prueba`: comprobar tras importar que sigue en *Eliminar procesos 1 día después de finalizar* (el paquete lo incluye, pero el MCP no puede verificarlo).
